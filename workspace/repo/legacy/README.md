...
The router/index is `workspace/repo/core/legacy.md`.
...
If a legacy file may contain sensitive content, record only its original path and `owner review required` in `workspace/repo/core/repo-intake.md`.
