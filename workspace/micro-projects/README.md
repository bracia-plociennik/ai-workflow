...
Micro-projects are small, self-contained work items that do not need a full `workspace/projects/<project>/` workspace, architecture, project plan, spec QA, quality phase, distillation, checkpoint, or autopilot run.
