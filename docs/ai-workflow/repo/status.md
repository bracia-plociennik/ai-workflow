...
| `current-task` | `workflow namespace collision hardening` |
...
- `docs/ai-workflow/` and `scripts/ai-workflow/` are the workflow-owned namespaces for safe installation in existing repositories.
