...
| Area | Purpose | Notes |
| --- | --- | --- |
| Root entrypoints | Internal execution contract, human runbook, and target shim template | In target repos, only `docs/ai-workflow/ai/templates/root-agents.template.md` is copied or merged as root `AGENTS.md`; `HUMANS.md` stays available at `ai-workflow/HUMANS.md`. |
...
| `docs/ai-workflow/ai/templates/root-agents.template.md` | Target-repository entrypoint shim | Delegates from target root `AGENTS.md` to `ai-workflow/AGENTS.md`. |
