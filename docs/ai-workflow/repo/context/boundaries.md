...
- Target install boundary: in target repositories, AI Workflow is workflow-owned only as the nested clone directory `ai-workflow/` plus the root `AGENTS.md` shim copied or merged from `ai-workflow/root-agents.template.md`.
