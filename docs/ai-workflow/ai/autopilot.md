...
- `AGENTS.md`
- `docs/ai-workflow/ai/operating-model.md`
- `docs/ai-workflow/ai/workflow.md`
- `docs/ai-workflow/ai/risk-model.md`
- current phase files under `docs/ai-workflow/ai/workflow/`
...
- Spec QA has `PASS`;
- risk class permits autopilot under `docs/ai-workflow/ai/risk-model.md`;
- required commands are known through `docs/ai-workflow/repo/repo-intake.md` and `docs/ai-workflow/ai/commands.md`.
