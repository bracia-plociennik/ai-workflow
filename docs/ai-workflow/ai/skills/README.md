...
```text
docs/ai-workflow/ai/skills/<skill-name>/README.md
```

Example future skill paths:

```text
docs/ai-workflow/ai/skills/frontend-dev/README.md
docs/ai-workflow/ai/skills/backend-api/README.md
docs/ai-workflow/ai/skills/database-migrations/README.md
```
...
- override `AGENTS.md`;
- weaken `docs/ai-workflow/ai/operating-model.md`;
- bypass phase gates;
