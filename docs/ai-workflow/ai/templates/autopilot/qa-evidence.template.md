...
Purpose: standard evidence artifact for SPEC QA, QUALITY, final check, or other PASS/FAIL gates. Store project-specific copies under `docs/ai-workflow/projects/<project>/quality/`.
