...
`docs/ai-workflow/projects/<project>/memory/` stores detailed project memory entries.

The router/index is `docs/ai-workflow/projects/<project>/memory.md`.
...
Use `docs/ai-workflow/ai/templates/projects/date-memory-entry.template.md` for new entries.
...
After adding or updating an entry, update `docs/ai-workflow/projects/<project>/memory.md` with only date, topic, type, status, and route.
