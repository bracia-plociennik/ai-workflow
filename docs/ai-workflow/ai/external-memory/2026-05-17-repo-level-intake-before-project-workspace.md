...
- Why it matters: a new repository can validate `AGENTS.md`, `HUMANS.md`, `docs/ai-workflow/ai`, templates, status, safe command policy, and STOP conditions before a concrete project exists.
