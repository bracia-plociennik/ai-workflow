...
## **Minimalny zakres artefaktu docs/ai-workflow/projects/<project>/architecture/phase-1-architecture.md**
...
DoD fazy:
powstał artefakt docs/ai-workflow/projects/<project>/architecture/phase-1-architecture.md
```
