...
- `docs/ai-workflow/projects/<project>/quality/phase-1-architecture-qa.md` lists findings.
- Current architecture artifact is available.

### Output required

- Updated `docs/ai-workflow/projects/<project>/architecture/phase-1-architecture.md`.
- Fix evidence in `docs/ai-workflow/projects/<project>/quality/phase-1-architecture-fix-loop.md`.
- Updated project status.

### Pass criteria

- Every failing Architecture QA finding is fixed, deferred with approval, or escalated.
- No unrelated architecture changes are introduced.
- Architecture is ready for another Architecture QA run.

### Fail criteria

- A QA finding remains unresolved without escalation.
- Fix introduces new unresolved architecture decisions.
- Fix changes scope beyond QA findings.
...
- Architecture sections changed.
- Evidence that each finding is fixed or escalated.

### Next allowed phases

- `phase-1-architecture-qa` only.
...
- Architecture artifact, fix-loop evidence, project status, decisions/escalations.
...
- istnieje artefakt:
  `docs/ai-workflow/projects/<project>/architecture/phase-1-architecture.md`
