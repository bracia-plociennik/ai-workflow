...
- `docs/ai-workflow/projects/<project>/quality/phase-2-plan-qa.md` with `PASS` or `FAIL`.
...
Sprawdź, czy `docs/ai-workflow/projects/<project>/tasks.md` jest kompletnym operacyjnym indeksem planu.
