...
- Distillation artifact under `docs/ai-workflow/projects/<project>/distillations/`.
...
`docs/ai-workflow/projects/<project>/distillations/phase-6-<task-id>-distillation.md`
...
DoD fazy:
powstał artefakt docs/ai-workflow/projects/<project>/distillations/phase-6-<task-id>-distillation.md
```
