...
- `docs/ai-workflow/projects/<project>/architecture/phase-1-architecture.md` and project context are available.
...
DoD fazy:
powstał artefakt docs/ai-workflow/projects/<project>/planning/phase-2-project-plan.md
```
