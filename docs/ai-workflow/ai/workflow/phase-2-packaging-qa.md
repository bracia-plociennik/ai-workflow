...
- `docs/ai-workflow/projects/<project>/quality/phase-2-packaging-qa.md` with `PASS`, `FAIL`, or `skipped` when no package exists.
...
- istnieje output pakietyzacji, istnieje sekcja `Tasks package` w artefakcie `docs/ai-workflow/projects/<project>/planning/phase-2-project-plan.md`
...
Jeśli wynik fazy 2.7. jest taki, że nie utworzono żadnych pakietów lub jeśli sekcja `Tasks package` w `docs/ai-workflow/projects/<project>/planning/phase-2-project-plan.md` wskazuje, że nie utworzono żadnych pakietów::
...
Wejście:
- docs/ai-workflow/projects/<project>/planning/phase-2-project-plan.md
- output fazy 2.7. Task Packaging, sekcja `Tasks package` z `docs/ai-workflow/projects/<project>/planning/phase-2-project-plan.md`
