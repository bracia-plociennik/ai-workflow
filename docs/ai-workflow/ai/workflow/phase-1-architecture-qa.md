...
- `docs/ai-workflow/projects/<project>/architecture/phase-1-architecture.md` exists.
...
- `docs/ai-workflow/projects/<project>/quality/phase-1-architecture-qa.md` with `PASS` or `FAIL`.
