...
`docs/ai/external-memory/` is portable advisory memory for improving the AI Workflow system itself.
...
The router/index is `docs/ai/core/external-memory.md`.
...
- `docs/ai/core/workflow.md` and `docs/ai/workflow/` as workflow rules;
- `docs/ai/core/memory.md` and `docs/ai/memory/` as template-local memory router and entries;
- `docs/repo/core/memory.md` and `docs/repo/memory/` as repo-specific memory router and entries;
- `docs/projects/<project>/memory.md` and `docs/projects/<project>/memory/` as project-specific memory router and entries;
...
| --- | --- | --- | --- |
| `docs/ai/external-memory/` | universal workflow/process memory | cross-repo workflow improvements, reusable autopilot rules, process anti-patterns, template and skill improvements | repo facts, domain facts, task-specific implementation knowledge |
| `docs/ai/core/memory.md` and `docs/ai/memory/` | this workflow template | template-local maintenance facts and history | target-repo facts or universal workflow lessons |
| `docs/repo/core/memory.md` and `docs/repo/memory/` | one repository | durable facts about this repo, local constraints, local history | generic workflow improvements meant for other repos |
| `docs/projects/<project>/memory.md` and `docs/projects/<project>/memory/` | one project/workspace | durable project decisions, project architecture facts, project-specific lessons | generic workflow system design |
...
Use `docs/ai/templates/external-memory/date-external-memory.template.md` for new entries.

After adding or updating an entry, update `docs/ai/core/external-memory.md` with only date, topic, type, status, and route.
...
- universal process rule -> `docs/ai/workflow/README.md`;
- agent execution rule -> `AGENTS.md`;
- human operating guidance -> `HUMANS.md`;
- template change -> `docs/ai/templates/`;
- skill improvement -> `docs/ai/skills/`;
- autopilot rule -> `docs/ai/core/autopilot.md`;
- repo bootstrap requirement -> `docs/repo/core/repo-intake.md`.
