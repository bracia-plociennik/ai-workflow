...
- Recommendation: keep `docs/ai/core/external-memory.md` as the router and `docs/ai/external-memory/` as the detailed entry directory for universal recommendations, rules, and observations about the workflow system itself.
