...
Use `docs/ai/workflow.md` as the canonical phase router.

## Canonical Rule

- Phase files in this directory define phase-specific gates.
- Policy rules live in `docs/ai/*.md`.
- Templates live in `docs/ai/templates/`.
- Runtime facts live in `docs/repo/` and `docs/projects/<project>/`.
...
Every phase file must include `## Gate Conditions` with the required headings defined in `docs/ai/workflow.md`.
