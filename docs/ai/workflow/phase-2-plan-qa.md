...
- `docs/projects/<project>/planning/phase-2-project-plan.md` exists.
- `docs/projects/<project>/plans.md` exists and routes to the plan under review.
- `docs/projects/<project>/tasks.md` exists and is current.
- Architecture QA result is `PASS`.

### Output required

- `docs/projects/<project>/quality/phase-2-plan-qa.md` with `PASS` or `FAIL`.
...
Sprawdź, czy `docs/projects/<project>/tasks.md` jest kompletnym operacyjnym indeksem planu.
