...
- `docs/projects/<project>/quality/phase-8-final-check.md` with technical `PASS`, `FAIL`, or `awaiting-owner-final-yes`.
...
- brak sprzeczności między:
  - repo
  - architekturą
  - project memory router `docs/projects/<project>/memory.md` and entries under `docs/projects/<project>/memory/`
  - repo memory router `docs/repo/core/memory.md` and entries under `docs/repo/memory/`
  - external memory router `docs/ai/core/external-memory.md` and entries under `docs/ai/external-memory/`, jeśli etap promował uniwersalne lekcje workflow
  - checkpointami
...
- `docs/projects/<project>/memory.md` i `docs/projects/<project>/memory/` są zsynchronizowane
- `docs/repo/core/memory.md` i `docs/repo/memory/` są zsynchronizowane, jeśli checkpoint dotyczył wiedzy repo-level
- `docs/ai/core/external-memory.md` i `docs/ai/external-memory/` są zsynchronizowane, jeśli checkpoint dotyczył uniwersalnej wiedzy workflow, a użyte wpisy są osobnymi plikami z privacy check
