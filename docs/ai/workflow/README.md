...
- `../workflow.md` as the phase router.
- `../operating-model.md` for the top-level operating model.
...
Do not add a second workflow router here. Add or update the smallest relevant phase artifact and keep `../workflow.md` pointing to it.
