...
- `docs/projects/<project>/quality/phase-2-plan-qa.md` lists findings.
- Project plan, `plans.md`, and `tasks.md` are available.

### Output required

- Updated project plan, `docs/projects/<project>/plans.md`, and `docs/projects/<project>/tasks.md` when findings require it.
- Fix evidence in `docs/projects/<project>/quality/phase-2-plan-fix-loop.md`.
