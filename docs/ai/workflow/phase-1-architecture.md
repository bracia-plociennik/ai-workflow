...
## **Minimalny zakres artefaktu docs/projects/<project>/architecture/phase-1-architecture.md**
...
DoD fazy:
powstał artefakt docs/projects/<project>/architecture/phase-1-architecture.md
```
