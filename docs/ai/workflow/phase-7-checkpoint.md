...
- Updated `docs/projects/<project>/project-memory.md` and `docs/repo/memory.md` when applicable.
...
2. zaktualizować `docs/projects/<project>/project-memory.md`
...
Jeśli `docs/projects/<project>/project-memory.md` nie istnieje:
