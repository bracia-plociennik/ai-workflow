...
- Distillation artifact under `docs/projects/<project>/distillations/`.
...
`docs/projects/<project>/distillations/phase-6-<task-id>-distillation.md`
...
DoD fazy:
powstał artefakt docs/projects/<project>/distillations/phase-6-<task-id>-distillation.md
```
