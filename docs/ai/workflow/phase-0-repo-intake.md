...
- `docs/repo/context.md` exists or can be created from `docs/ai/templates/ai/repo-context.template.md`.
- Existing `docs/repo/status.md`, `docs/repo/repo-intake.md`, and project intake artifacts are reconciled when present.

### Output required

- `docs/repo/repo-intake.md` for repo-level readiness.
- `docs/projects/<project>/intake/phase-0-repo-intake.md` when intake is project-specific.
- Updated `docs/repo/status.md` and safe command map.
...
- `docs/repo/context.md`, `docs/repo/repo-intake.md`, `docs/repo/status.md`, `docs/repo/memory.md`.
...
Repo-level context powinien być zapisany w `docs/repo/context.md`. Project-local `context.md` jest opcjonalny dla repo-level intake, ale wymagany przed architekturą konkretnego projektu.
...
Brak aktywnego projektu nie blokuje repo-level intake. W takim przypadku artefaktem fazy jest `docs/repo/repo-intake.md`, a nie project-local `phase-0-repo-intake.md`.
...
- `docs/projects/<project>/project-memory.md`, jeśli projekt już istnieje;
...
```text
docs/projects/<project>/intake/context.md
```
...
- `docs/projects/<project>/project-memory.md`, jeśli projekt istnieje;
...
Ta checklista ma trafić do `docs/repo/repo-intake.md` przy repo-level bootstrap intake albo do `phase-0-repo-intake.md` przy project/context-specific intake.
...
- `docs/projects/<project>/intake/context.md` - zaakceptowany context projektu.
