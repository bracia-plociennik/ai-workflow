...
- Safe verification commands and environment from `docs/repo/core/repo-intake.md` are known.

### Output required

- Implementation changes limited to the accepted spec.
- `docs/projects/<project>/quality/phase-4-<task-id>-implementation-result.md`.
