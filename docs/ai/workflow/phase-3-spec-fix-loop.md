...
- Fix evidence in `docs/projects/<project>/quality/phase-3-<task-id>-spec-fix-loop.md`.
...
- aktualizacja artefaktu `docs/projects/<project>/specs/phase-3-<task-id>-specification.md`
...
- potwierdzenie aktualizacji artefaktu `docs/projects/<project>/specs/phase-3-<task-id>-specification.md`
