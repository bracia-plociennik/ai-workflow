...
- `docs/projects/<project>/quality/phase-1-architecture-qa.md` lists findings.
- Current architecture artifact is available.

### Output required

- Updated `docs/projects/<project>/architecture/phase-1-architecture.md`.
- Fix evidence in `docs/projects/<project>/quality/phase-1-architecture-fix-loop.md`.
...
- istnieje artefakt:
  `docs/projects/<project>/architecture/phase-1-architecture.md`
