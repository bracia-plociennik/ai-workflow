...
- A ready task or approved package is selected from `docs/projects/<project>/tasks.md`.
...
- Task or package specification under `docs/projects/<project>/specs/`.
- Updated `docs/projects/<project>/tasks.md` spec path/status and optional `tasks/<task-id>.md` when a task card exists.
...
- artefakt `docs/projects/<project>/specs/phase-3-<task-id>-specification.md` zapisuje wynik tego planowania 1:1
...
- `docs/projects/<project>/specs/phase-3-<task-id>-specification.md`
...
- Istnieje artefakt docs/projects/<project>/specs/phase-3-<task-id>-specification.md
