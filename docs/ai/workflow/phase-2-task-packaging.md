...
- Plan QA has `PASS`.
- `docs/projects/<project>/tasks.md` identifies ready tasks and dependencies; optional task cards in `tasks/` are reviewed when present.
- Parallel/package candidates are known or the work is explicitly solo-task execution.

### Output required

- Packaging decision/evidence in `docs/projects/<project>/quality/phase-2-task-packaging.md` or equivalent planning artifact.
...
- potwierdzenie aktualizacji sekcji `Tasks package` w pliku `docs/projects/<project>/planning/phase-2-project-plan.md`
...
Brak aktualizacji sekcji `Tasks package` w `docs/projects/<project>/planning/phase-2-project-plan.md`:
