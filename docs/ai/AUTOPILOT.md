...
It does not replace `AGENTS.md`, `docs/ai/WORKFLOW.md`, `docs/ai/workflow/`, or project-local `STATUS.md`.
...
As of this template setup, `docs/ai` contains the required global materials for running autopilot. Actual readiness still depends on the active project workspace and current `STATUS.md` values.
