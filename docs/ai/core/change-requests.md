...
- router: `docs/projects/<project>/change-requests.md`;
- directory: `docs/projects/<project>/change-requests/`;
- entry: `docs/projects/<project>/change-requests/YYYY-MM-DD-<project>-cr-<nnn>-<slug>.md`.
...
- route decision rollback through `docs/ai/core/command-routing.md` and existing decision rollback policy;
...
- removals and superseded artifacts must follow `docs/ai/core/deprecation.md`;
- production-impacting recovery or reversal must follow `docs/ai/core/rollback.md`.
