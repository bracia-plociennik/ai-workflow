...
Codex must know how to verify work. Repository-specific commands live in `docs/repo/core/repo-intake.md`. This file defines the required command categories and workflow-template checks.

## Required Command Categories

Each target repository should define these in `docs/repo/core/repo-intake.md`:
