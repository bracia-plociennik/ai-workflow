...
Detailed review artifacts live in `docs/projects/<project>/reviews/`.
...
| --- | --- | --- | --- |
| `<YYYY-MM-DD>` | `<task-id>` | `<PASS|FAIL|blocked>` | `docs/projects/<project>/reviews/<YYYY-MM-DD-task-id-review>.md` |
