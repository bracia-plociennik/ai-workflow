...
Detailed legacy inputs live in `docs/repo/legacy/`.
...
| --- | --- | --- | --- | --- |
| `<original path or source>` | `docs/repo/legacy/<file>` | `<keep-as-context|adapt-to-runtime|superseded|ignore|owner-decision>` | `<pending|reviewed|blocked>` | `<notes>` |
...
- Store preserved legacy inputs in `docs/repo/legacy/`.
- Extract useful current-repo facts into `docs/repo/core/context.md`, `docs/repo/context/`, or `docs/repo/core/repo-intake.md`.
