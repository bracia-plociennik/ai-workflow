...
- Project: `<project>`
- Date: `<YYYY-MM-DD>`
- Failed QA artifact: `docs/projects/<project>/quality/phase-1-architecture-qa.md`
- Fixed architecture artifact: `docs/projects/<project>/architecture/phase-1-architecture.md`
