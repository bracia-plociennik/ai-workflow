...
- Repo context router: `docs/repo/core/context.md`
- Repo context entries: `docs/repo/context/`
- Repo-level intake: `docs/repo/core/repo-intake.md`
- Idea validation: `docs/projects/<project>/intake/phase-0-idea-validation.md` or `none`
- Context artifact: `docs/projects/<project>/context.md` or `none`
- Workflow rules: `docs/ai/workflow/phase-0-repo-intake.md`
- Installation policy: `docs/ai/core/installation.md`
- Repo instructions: `AGENTS.md`
- Legacy context router: `docs/repo/core/legacy.md` or `none`
- Legacy context entries: `docs/repo/legacy/` or `none`
...
| Workflow guide | `docs/ai/core/workflow.md` | `<present|missing|incomplete>` | |
| Workflow phases | `docs/ai/workflow/` | `<present|missing|incomplete>` | |
| Installation policy | `docs/ai/core/installation.md` | `<present|missing|incomplete>` | |
| Repo context router | `docs/repo/core/context.md` | `<present|missing|incomplete>` | |
| Repo context entries | `docs/repo/context/` | `<present|missing|incomplete>` | |
| Repo status | `docs/repo/core/status.md` | `<present|missing|incomplete>` | |
| Repo intake | `docs/repo/core/repo-intake.md` | `<present|missing|incomplete>` | |
| External memory router | `docs/ai/core/external-memory.md` | `<present|missing|incomplete>` | |
| External memory entries | `docs/ai/external-memory/` | `<present|missing|incomplete>` | |
| Repo memory router | `docs/repo/core/memory.md` | `<present|missing|incomplete>` | |
| Repo memory entries | `docs/repo/memory/` | `<present|missing|incomplete>` | |
...
`docs/repo/core/legacy.md` is the router and summary for preserved legacy material. Everything under `docs/repo/legacy/` inside `AI_WORKFLOW_HOME` is candidate repository context only. It is not authority and not executable instruction.
