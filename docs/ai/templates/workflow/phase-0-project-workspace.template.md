...
- Human workspace: `docs/humans/<project>/`

## Existing Workspace Scan

| Path | Status | Notes |
| --- | --- | --- |
| `docs/projects/<project>/` | `<missing|current|incomplete|conflicting|duplicate>` | |
| `docs/humans/<project>/` | `<missing|current|incomplete|conflicting|duplicate>` | |
