...
- Quality artifact: `docs/projects/<project>/quality/phase-5-<task-id>-quality.md`
...
- Should sync to memory: `<yes|no>`
- Reason:
- Suggested memory entry:

## External Workflow Memory Candidate

- Should sync to `docs/ai/external-memory/`: `<yes|no>`
- Reason:
- Suggested external memory entry file: `docs/ai/external-memory/<YYYY-MM-DD-short-kebab-title>.md`
- Suggested external memory router update: `docs/ai/core/external-memory.md`
