...
| --- | --- | --- |
| 0 repo intake | `phase-0-repo-intake.template.md` | `docs/repo/core/repo-intake.md` or `docs/projects/<project>/intake/phase-0-repo-intake.md` |
| 0 project workspace | `phase-0-project-workspace.template.md` | `docs/projects/<project>/` and `docs/humans/<project>/` |
