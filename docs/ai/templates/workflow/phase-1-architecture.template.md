...
- Architecture result: `<PASS|blocked|draft>`

## Sources

- Repo state:
- Initial audit: `docs/projects/<project>/intake/phase-0-repo-intake.md`
- Context: `docs/projects/<project>/intake/context.md` or `none`
- Workflow rules: `docs/ai/workflow/phase-1-architecture.md`
- Supporting sources:
...
| Dependency | Type | Direction | Risk |
| --- | --- | --- | --- |
| | | | |
...
| Assumption | Why Acceptable Now | Revalidation Point |
| --- | --- | --- |
| | | |

## Blocking Unknowns

| Unknown | Why Blocking | Required Resolution |
| --- | --- | --- |
| | | |
...
- Risks have owner/mitigation: `<yes|no>`
