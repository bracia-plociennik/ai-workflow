...
- Project: `<project>`
- Date: `<YYYY-MM-DD>`
- Failed QA artifact: `docs/projects/<project>/quality/1_5_architecture_qa.md`
- Fixed architecture artifact: `docs/projects/<project>/architecture/1_architecture_phase.md`
