...
- Project: EXAMPLE
- Date: 2026-05-16
- Artifact under review: `docs/projects/EXAMPLE/architecture/phase-1-architecture.md`
...
manual-checks:
  ...
  - check: "internal consistency"
    result: "PASS"
    notes: "Referenced paths stay inside docs/projects/EXAMPLE."
artifacts-reviewed:
  - "docs/projects/EXAMPLE/architecture/phase-1-architecture.md"
skipped-checks: []
```
