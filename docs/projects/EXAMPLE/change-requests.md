...
Detailed change request entries live in `docs/projects/EXAMPLE/change-requests/`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `EX-CR-001-pre-final-copy-correction` | `pre-final-approval` | `acceptance-gap` | `low` | `done` | `phase-fix-loop` | `docs/projects/EXAMPLE/change-requests/2026-05-21-example-cr-001-pre-final-copy-correction.md` | `yes` |
| `EX-CR-002-post-final-docs-note` | `post-final-approval` | `docs-only` | `low` | `done` | `micro-task` | `docs/projects/EXAMPLE/change-requests/2026-05-21-example-cr-002-post-final-docs-note.md` | `not-applicable` |
