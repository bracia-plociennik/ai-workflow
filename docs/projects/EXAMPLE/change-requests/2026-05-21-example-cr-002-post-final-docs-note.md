...
- Next phase or artifact: `docs/projects/EXAMPLE/micro-tasks/`.
...
- Links to resulting artifacts: `docs/projects/EXAMPLE/micro-tasks/2026-05-20-example-micro-task.md`
