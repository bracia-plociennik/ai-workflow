...
Detailed task cards live in `docs/projects/EXAMPLE/tasks/`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `EX-DOCS-001-example-task` | Example Task | low | example-only | `docs/projects/EXAMPLE/tasks/ex-docs-001-example-task.md` | `docs/projects/EXAMPLE/specs/phase-3-ex-01-example-task-specification.md` | `docs/projects/EXAMPLE/quality/phase-5-ex-01-quality.md` | Demonstrates task tracking only. |
