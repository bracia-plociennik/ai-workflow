...
Detailed review artifacts live in `docs/projects/EXAMPLE/reviews/`.
...
| --- | --- | --- | --- |
| 2026-05-16 | `EX-DOCS-001-example-task` | example-only | `docs/projects/EXAMPLE/reviews/2026-05-16-ex-docs-001-example-task-review.md` |
