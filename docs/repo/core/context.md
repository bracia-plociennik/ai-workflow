...
| --- | --- | --- | --- |
| Repository overview | overview | current | `docs/repo/context/overview.md` |
| Stack and runtime | stack | current | `docs/repo/context/stack.md` |
| Main repository areas | areas | current | `docs/repo/context/areas.md` |
| Boundaries | boundaries | current | `docs/repo/context/boundaries.md` |
| Local operating rules | local-rules | current | `docs/repo/context/local-rules.md` |
