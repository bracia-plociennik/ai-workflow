...
`ai-workflow-workspace/repo/memory/` stores detailed memory entries for the current target repository.

The router/index is `ai-workflow-workspace/repo/core/memory.md`.
...
Universal workflow lessons belong in `ai-workflow-workspace/external-memory/memory/` and are indexed by `ai-workflow-workspace/external-memory/external-memory.md`.

Project-specific facts belong in `ai-workflow-workspace/projects/<project>/memory/` and are indexed by `ai-workflow-workspace/projects/<project>/memory.md`.

## Router Rule

After adding or updating an entry, update `ai-workflow-workspace/repo/core/memory.md` with only:
