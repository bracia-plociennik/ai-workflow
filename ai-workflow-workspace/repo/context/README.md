...
The router/index is `ai-workflow-workspace/repo/core/context.md`.

Files in this directory are supporting repo context entries and are exempt from `.systems/scripts/check-naming`. The canonical router is still `ai-workflow-workspace/repo/core/context.md` and should remain lowercase kebab-case.
...
- Do not store project-specific context here; use `ai-workflow-workspace/projects/<project>/context/`.
- Do not store secrets, credentials, private customer data, or production-only operational details.
- Update `ai-workflow-workspace/repo/core/context.md` when adding, renaming, or superseding an entry.
