...
- Out of scope for this repository: application code, real product architecture, production deployment, secrets, customer data, paid vendor commitments, and target-repository domain facts outside `ai-workflow-workspace/repo/` examples.
