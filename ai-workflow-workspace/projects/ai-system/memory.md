# AI System Project Memory Router

## Purpose

This file indexes durable project memory for the `ai-system` project.

Detailed entries live in `AI_WORKFLOW_WORKSPACE_HOME/projects/ai-system/memory/`.
