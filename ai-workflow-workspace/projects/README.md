...
Repo-level workflow/bootstrap intake belongs in `ai-workflow-workspace/repo/core/repo-intake.md`. Do not create a project workspace only to validate that the workflow template is installed correctly.
...
- Do not treat historical workspaces as active unless `ai-workflow-workspace/repo/core/status.md` points to them.
