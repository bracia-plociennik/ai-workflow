...
Micro-projects are small, self-contained work items that do not need a full `ai-workflow-workspace/projects/<project>/` workspace, architecture, project plan, spec QA, quality phase, distillation, checkpoint, or autopilot run.
...
- Real target-repository micro-projects are target-owned runtime and are protected by `.systems/scripts/update-from-upstream`.

## Layout

```text
ai-workflow-workspace/micro-projects/
  README.md
  EXAMPLE/
    README.md
    micro-project.md
