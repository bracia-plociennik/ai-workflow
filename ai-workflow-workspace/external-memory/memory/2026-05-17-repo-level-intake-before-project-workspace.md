...
- Recommendation: keep `ai-workflow-workspace/repo/core/repo-intake.md` as a repo-level bootstrap/readiness artifact that can exist before any project workspace.
- Why it matters: a new repository can validate `AGENTS.md`, `HUMANS.md`, `.systems/ai`, templates, status, safe command policy, and STOP conditions before a concrete project exists.
