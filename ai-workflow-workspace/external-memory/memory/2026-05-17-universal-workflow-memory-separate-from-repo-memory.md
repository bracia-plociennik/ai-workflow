...
- Recommendation: keep `ai-workflow-workspace/external-memory/external-memory.md` as the router and `ai-workflow-workspace/external-memory/memory/` as the detailed entry directory for universal recommendations, rules, and observations about the workflow system itself.
...
- Applies to:
  ...
  - `ai-workflow-workspace/external-memory/external-memory.md`
