...
- `.systems/ai/core/workspace-freshness.md` and `.systems/ai/core/contract-topology.md` define advisory runtime ledgers. `.systems/ai/core/validation-observability.md` defines measured validator timing and smoke-group equivalence boundaries. `.systems/ai/core/skill-behavioral-evaluation.md` defines optional skill behavior evidence.
