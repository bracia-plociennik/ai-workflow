...
- `AI_WORKFLOW_WORKSPACE_HOME/repo/core/legacy.md` is the legacy context router and summary; preserved source material lives in `AI_WORKFLOW_WORKSPACE_HOME/repo/legacy/`.
