...
Use `.systems/ai/core/workspace-freshness.md` and `.systems/ai/core/contract-topology.md` for advisory runtime and contract maps. Use `.systems/ai/core/validation-observability.md` before changing validation cost or smoke-suite coverage. Use `.systems/ai/core/skill-behavioral-evaluation.md` for optional skill behavior evidence.
