...
Active AI Workflow guidance for building and reviewing production frontend interfaces.

The canonical contract is [`SKILL.md`](SKILL.md). This README is only a short overview and does not replace it.
