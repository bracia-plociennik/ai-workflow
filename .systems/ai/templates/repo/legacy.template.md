...
Detailed legacy inputs live in `workspace/repo/legacy/`.
...
| --- | --- | --- | --- | --- |
| `<original path or source>` | `workspace/repo/legacy/<file>` | `<keep-as-context|adapt-to-runtime|superseded|ignore|owner-decision>` | `<pending|reviewed|blocked>` | `<notes>` |
...
- Store preserved legacy inputs in `workspace/repo/legacy/`.
- Extract useful current-repo facts into `workspace/repo/core/context.md`, `workspace/repo/context/`, or `workspace/repo/core/repo-intake.md`.
