...
| --- | --- | --- | --- |
| Repository overview | overview | `<current|missing|incomplete>` | `workspace/repo/context/overview.md` |
| Stack and runtime | stack | `<current|missing|incomplete>` | `workspace/repo/context/stack.md` |
| Main repository areas | areas | `<current|missing|incomplete>` | `workspace/repo/context/areas.md` |
| Boundaries | boundaries | `<current|missing|incomplete>` | `workspace/repo/context/boundaries.md` |
| Local operating rules | local-rules | `<current|missing|incomplete>` | `workspace/repo/context/local-rules.md` |
