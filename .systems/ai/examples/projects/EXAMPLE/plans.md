...
| --- | --- | --- | --- |
| Example project plan | example-only | `.systems/ai/examples/projects/EXAMPLE/planning/phase-2-project-plan.md` | Demonstrates phase-2 project planning location. |
