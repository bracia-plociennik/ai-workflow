...
Detailed task cards live in `.systems/ai/examples/projects/EXAMPLE/tasks/`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `EX-DOCS-001-example-task` | Example Task | low | example-only | `.systems/ai/examples/projects/EXAMPLE/tasks/ex-docs-001-example-task.md` | `.systems/ai/examples/projects/EXAMPLE/specs/phase-3-ex-01-example-task-specification.md` | `.systems/ai/examples/projects/EXAMPLE/quality/phase-5-ex-01-quality.md` | Demonstrates task tracking only. |
